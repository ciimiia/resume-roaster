      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(20px,5vw,40px) 80px' }}>
        ...
        <div style={{ marginBottom: 40, animation: 'fadeUp .5s both' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 20, paddingBottom: 28, borderBottom: '1px solid var(--line)' }}>
            ...
            <div>
              <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--ink)', fontFamily: 'var(--font-display)' }}>Resume Roaster</div>
        ...
        <div style={{
          ...
          <p style={{ position: 'relative', color: 'var(--ink-mute)', fontSize: 16, marginBottom: 24 }}>
            Upload your resume and get AI feedback in 12 seconds.
          </p>
          <Link href="/" style={{
        ...
        {others.length > 0 && (
          <div style={{ marginTop: 64 }}>
            <h3 style={{ fontSize: 20, marginBottom: 20, color: 'var(--ink)' }}>More posts</h3>
              ...
              {others.map(p => (
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'var(--ink-faint)' }}>{p.readTime} min read</div>
                  </div>
